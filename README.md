...
[![Test](https://github.com/step-security/run-windows-docker-container-action/actions/workflows/test.yml/badge.svg)](https://github.com/step-security/run-windows-docker-container-action/actions/workflows/test.yml)
    ...
    steps:
      - name: Checkout
        ...
        with:
          fetch-depth: 0
      - name: Test_Run
        uses: step-security/run-windows-docker-container-action@v2
        with:
